...
@section('title','Author | Employees | Edit')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ route('author.employees.update', $employee->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="employee_id" class="form-control" value="{{ empty(old('employee_id')) ? $employee->emply_id : old('employee_id')  }}" required>
                                ...
                                <br>
                                <input type="checkbox" class="filled-in" id="ig_checkbox" name="status" value="1" {{ empty(old('status')) ? ($employee->status == 1 ? 'checked' : '') : (old('status') == 1 ? 'checked' : '') }}>
                                <label for="ig_checkbox">Is Active</label>
