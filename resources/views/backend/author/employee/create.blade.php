    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ route('author.employees.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <textarea class="form-control" name="about" rows="5" placeholder="Please choose a date...">{{ old('about') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
