...
<div class="modal fade" id="craeateCategory" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.product-types.store')}}" method="post" id="store_form" enctype="multipart/form-data">
...
<script>
    ...
    $(".edit").click(function(event) {
        var id = $(this).data('id');
        // var update_url = location.origin + "/admin/product-types/" + id;
        var url = location.origin + '/admin/product-types/' + id;
