...
@section('title','Admin | Purchased | Product')
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <td>{{ $product->purchase->reference_invoice }} </td>
                            </tr>
                            <tr>
                                <th>Challan No.</th>
                                <td>{{ $product->purchase->challan_no }}</td>
                            ...
                            <tr>
                                <th>Supplier</th>
                                <td>{{ $product->purchase->supplier->company }}</td>

                                <th>Contact Person</th>
                                <td>{{ $product->purchase->supplier->name }}</td>
                                
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td>{{ $product->purchase->supplier->phone }}</td>
                                <th>Email</th>
                                <td>{{ $product->purchase->supplier->email }}</td>
                               
                            </tr>
                            <tr>
                                <th>Address</th>
                                <td> {{ $product->purchase->supplier->address }} </td>
                            </tr>
