                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.purchased.products.show', $data->id) }}" class="btn btn-info waves-effect ">
                                        ...
                                        <form id="delete-form-{{ $data->id }}" style="display: none;" action="{{ route('admin.purchases.inventory', $data->id) }}" method="post">
                                            @csrf
