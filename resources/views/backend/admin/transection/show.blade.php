...
@section('title','Admin | Distribution | Show ')
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th> {{ $transection->stock->product->type->slug == 'software' ? 'Subscription' : 'Warrenty' }} Period(Month)</th>
                                <td>{{ $transection->stock->warranty }}</td>
                                
                            </tr>
                            <tr>
                                <th> {{ $transection->stock->product->type->slug == 'software' ? 'Subscription' : 'Expired' }} Date</th>
                                <td>{{ $transection->stock->expired_date }}</td>
                            </tr>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>Mouse </th>
                                <td>{{ $transection->mouse == 1 ? "YES" : "NO" }}</td>
                            </tr>
                        
                            <tr>
                                <th>Bag</th>
                                <td>{{ $transection->bag == 1 ? "YES" : "NO" }}</td>
                                <th>Comments</th>
                                <td> {{ $transection->comment }} </td>
                            </tr>
