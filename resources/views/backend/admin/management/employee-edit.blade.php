                ...
                <div class="body table-responsive">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <form action="{{ route('admin.management.employees.update', $employee->id) }}" method="post" id="emplyeeForm">
                                    @csrf
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="text-center">
                                    <button type="button" class="btn btn-success" onclick="$('#emplyeeForm').submit();"> Update </button>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
