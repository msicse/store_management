        ...
        <div class="content">
            ...
            <table class="table">
                <tr>
                    ...
                    <th>Date </th>
                    <td class="text-center">:</td>
                    <td>{{ Carbon\Carbon::parse($transection->issued_date)->format('d M Y') }}</td>
                </tr>
                <tr>
                    <th>Employee Name</th>
                    <td class="text-center">:</td>
                    <td colspan="4">{{ $transection->employee->name }}</td>
                </tr>
                <tr>
                    <th>Designation: </th>
                    <td class="text-center">:</td>
                    ...
                    <th>Deprtment: </th>
                    <td class="text-center">:</td>
                    <td>{{ $transection->employee->department->short_name }}</td>
                </tr>
            ...
            <div class="product">
                ...
                @elseif($transection->stock->producttype->slug == 'monitor')
                    ...
                    <div class="items">
                        <label> <input type="checkbox" class="inp-check" checked> <strong> HDMI Cable </strong></label>
                    </div>
            ...
            <p>
                ...
                return all company property (specified above or on attached sheet) upon my last day of work (or as
                specified by my line-manager).
            </p>
            <p class="text-red">
                <strong>
